...
class Particle {
 public:
	Particle( ofVec3f _loc, ofVec3f _vel );
	void exist();
	...
	std::vector<ofVec3f> loc;        // array of position vectors
	ofVec3f startLoc;     // just used to make sure every loc[] is initialized to the same position
	ofVec3f vel;          // velocity vector
	ofVec3f perlin;       // perlin noise vector
